...
def run_colmap(
    ...
    # TODO: camera params KITTI, modified on 2023.07.25
    # fx = 707.0977
    # fy = 707.0912
    # cx = 601.8873
    # cy = 183.110 
    ...
    # p1 = 0
    # p2 = 0
    # params = ",".join(map(str, [fx, fy, cx, cy, k1, k2, p1, p2]))
    ...
    feature_extractor_cmd = [
        ...
        # f"--ImageReader.camera_params {params}", # update this line on 2023.07.25
