...
class RayGenerator(nn.Module):
    ...
    def forward(self, ray_indices: Int[Tensor, "num_rays 3"]) -> RayBundle:
        ...
        # print("Ray indices shape: ", ray_indices.shape)
        # print c size
        print("RayGenerator c.size(): ", c.size())
        # print c
        # print("RayGenerator c: ", c)
        y = ray_indices[:, 1]  # row indices
        # print("RayGenerator y: ", y)
        x = ray_indices[:, 2]  # col indices
        # print("RayGenerator x: ", x)
        coords = self.image_coords[y, x]
        # print("RayGenerator coords: ", coords)

        camera_opt_to_camera = self.pose_optimizer(c)
        # print("RayGenerator camera_opt_to_camera: ", camera_opt_to_camera)
        # print("RayGenerator camera_opt_to_camera.shape: ", camera_opt_to_camera.shape)
